...
var fixedKanjiList = new Array( "亜", "哀", "挨", "愛", "曖",
                                "悪", "握", "圧", "扱", "宛",
                                "嵐", "安", "案", "暗", "以",
                                "衣", "位", "囲", "医", "依",
                                "委", "威", "為", "畏", "胃",
...
function generateResults()
{
    ...
    var kanjiChoice = document.getElementById( "kanji" ).value;
    ...
    else if ( hiraganaChoice === "yes" && katakanaChoice === "no" && kanjiChoice === "no" )
    {
        if ( length <= 0 )
        {
            outputObject.innerHTML = "<p>Please select a positive length for the list.</p>";
    ...
    else if ( hiraganaChoice === "no" && katakanaChoice === "yes" && kanjiChoice === "no" )
    {
        if ( length <= 0 )
        {
            outputObject.innerHTML = "<p>Please select a positive length for the list.</p>";
    ...
    else if ( hiraganaChoice === "yes" && katakanaChoice === "yes" && kanjiChoice === "no" )
    {
        if ( length <= 0 )
        {
            outputObject.innerHTML = "<p>Please select a positive length for the list.</p>";
    ...
    else if ( hiraganaChoice === "no" && katakanaChoice === "no" && kanjiChoice === "yes" )
    {
        if ( length <= 0 )
        {
            outputObject.innerHTML = "<p>Please select a positive length for the list.</p>";
        ...
        {
            var list = generateRandomKanjiList( length );
    ...
    else if ( hiraganaChoice === "yes" && katakanaChoice === "no" && kanjiChoice === "yes" )
    {
        if ( length <= 0 )
        {
            outputObject.innerHTML = "<p>Please select a positive length for the list.</p>";
        ...
        {
            var list = generateRandomHiraganaAndKanjiList( length );
...
function generateRandomKanjiList( listLength )
{
    var counter;
    var randomKanjiList = new Array();
    
    for ( counter = 1 ; counter <= listLength ; ++counter )
    {
        randomKanjiList.push( fixedKanjiList[ Math.floor( Math.random() * fixedKanjiList.length ) ] );
    }
...
function generateRandomHiraganaAndKanjiList( listLength )
{
    var counter;
    var randomHiraganaList = generateRandomHiraganaList( Math.ceil( listLength / 2 ) );
    var randomKanjiList = generateRandomKanjiList( Math.floor( listLength / 2 ) );
    var randomHiraganaAndKanjiList = new Array();
